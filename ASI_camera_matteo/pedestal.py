...
def bg_map(bg_shots_path,outMeanPed_file, outStdPed_file, ny = 4144, nx = 2822, draw = 1, hist_pixel = None ):
  ...
  # lista file immagini:
   ...
   al.write_fitsImage(mean, outMeanPed_file, overwrite = 'False')
   al.write_fitsImage(std, outStdPed_file, overwrite = 'False')
...
if __name__ == "__main__":
  ...
  bg_shots_path = '/Users/matteo/Desktop/Università/UniTo/Terzo anno/Tesi/XCF-main/ASI_camera/Immagini/CapObj/2022-09-16_15_23_11Z'
