...
def CaptureAnalyze(camera, file_path, sample_size, WB_R, WB_B, EXPO, GAIN,bkg_folder_a, xyRebin, sigma, cluster, NoClustering, NoEvent, Raw, Eps):
    #Setting up variables
    pedfile  = bkg_folder_a + '/mean_ped.fits'
    pedSigmafile  = bkg_folder_a + '/std_ped.fits'
    REBINXY = xyRebin
    PIX_CUT_SIGMA = sigma
    CLU_CUT_SIGMA = cluster
    APPLY_CLUSTERING = NoClustering
    SAVE_EVENTLIST = NoEvent
    myeps = Eps
