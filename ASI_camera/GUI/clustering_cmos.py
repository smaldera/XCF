...
def clustering_v3(supp_coords,supp_weights,myeps=1, size_threshold=10, save_file='saved_clu'  ):
   ...
   #print("DEBUG... clustering_v3: start")
   ...
   # non dovrebbe mai arrivare qua con vettori vuoti!!
   ...
   #print("DEBUG... clustering_v3: prima di DBscan")
  
   
   db = DBSCAN(eps=myeps, min_samples=1, n_jobs=1, algorithm='ball_tree').fit(supp_coords)

   #print("DEBUG... clustering_v3: dopo di DBscan")
